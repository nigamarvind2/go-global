  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative bg-gradient-to-r from-primary to-primary/80 text-white py-16">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex items-center gap-2 text-white/80 mb-4">
            ...
            <span>/</span>
            <Link to="/mbbs-overseas" className="hover:text-white">MBBS Overseas</Link>
            <span>/</span>
            <Link to={`/mbbs-overseas/${country.slug}`} className="hover:text-white">
              {country.name}
            </Link>
            <span>/</span>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              <Card className="bg-primary text-white">
                <CardHeader>
                  <CardTitle className="text-white">Interested in {university.name}?</CardTitle>
                </CardHeader>
      ...
      <section className="py-12 bg-muted/30">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl font-bold text-center mb-8">Explore MBBS in Other Countries</h2>
